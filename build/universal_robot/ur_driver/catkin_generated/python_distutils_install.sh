...
echo_and_run cd "/ros/catkin_ws/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/ros/catkin_ws/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/ros/catkin_ws/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
