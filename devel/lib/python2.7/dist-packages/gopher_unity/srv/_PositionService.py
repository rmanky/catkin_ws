...
"""autogenerated by genpy from gopher_unity/PositionServiceRequest.msg. Do not edit."""
import codecs
import sys
...
"""
  __slots__ = ['input']
  _slot_types = ['gopher_unity/PosRot']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.input is None:
        self.input = gopher_unity.msg.PosRot()
    else:
      self.input = gopher_unity.msg.PosRot()
...
def _get_struct_7f():
    ...
    return _struct_7f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gopher_unity/PositionServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PositionServiceResponse(genpy.Message):
  ...
  _type = "gopher_unity/PositionServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.output is None:
        self.output = gopher_unity.msg.PosRot()
    else:
      self.output = gopher_unity.msg.PosRot()
...
class PositionService(object):
  _type          = 'gopher_unity/PositionService'
