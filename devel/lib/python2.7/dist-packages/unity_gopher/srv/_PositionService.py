...
"""autogenerated by genpy from unity_gopher/PositionServiceRequest.msg. Do not edit."""
import codecs
import sys
...
"""
  __slots__ = ['input']
  _slot_types = ['unity_gopher/PosRot']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.input is None:
        self.input = unity_gopher.msg.PosRot()
    else:
      self.input = unity_gopher.msg.PosRot()
...
def _get_struct_7f():
    ...
    return _struct_7f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from unity_gopher/PositionServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PositionServiceResponse(genpy.Message):
  ...
  _type = "unity_gopher/PositionServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.output is None:
        self.output = unity_gopher.msg.PosRot()
    else:
      self.output = unity_gopher.msg.PosRot()
...
class PositionService(object):
  _type          = 'unity_gopher/PositionService'
