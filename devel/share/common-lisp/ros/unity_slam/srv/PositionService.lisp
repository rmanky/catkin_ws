...
(cl:defclass <PositionService-request> (roslisp-msg-protocol:ros-message)
  ((input
    :reader input
    :initarg :input
    :type unity_slam-msg:PosRot
    :initform (cl:make-instance 'unity_slam-msg:PosRot)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PositionService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_slam-srv:<PositionService-request> is deprecated: use unity_slam-srv:PositionService-request instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <PositionService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_slam-srv:input-val is deprecated.  Use unity_slam-srv:input instead.")
  (input m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PositionService-request>)))
  ...
  "unity_slam/PositionServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PositionService-request)))
  "Returns string type for a service object of type 'PositionService-request"
  "unity_slam/PositionServiceRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PositionService-request>)))
  ...
  (cl:format cl:nil "PosRot input~%~%================================================================================~%MSG: unity_slam/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PositionService-request)))
  "Returns full string definition for message of type 'PositionService-request"
  (cl:format cl:nil "PosRot input~%~%================================================================================~%MSG: unity_slam/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <PositionService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_slam-srv:<PositionService-response> is deprecated: use unity_slam-srv:PositionService-response instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <PositionService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_slam-srv:output-val is deprecated.  Use unity_slam-srv:output instead.")
  (output m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PositionService-response>)))
  ...
  "unity_slam/PositionServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PositionService-response)))
  "Returns string type for a service object of type 'PositionService-response"
  "unity_slam/PositionServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PositionService-response>)))
  ...
  (cl:format cl:nil "PosRot output~%~%~%================================================================================~%MSG: unity_slam/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PositionService-response)))
  "Returns full string definition for message of type 'PositionService-response"
  (cl:format cl:nil "PosRot output~%~%~%================================================================================~%MSG: unity_slam/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%~%~%"))
