...
(cl:in-package unity_gopher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <PosRot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PosRot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_gopher-msg:<PosRot> is deprecated: use unity_gopher-msg:PosRot instead.")))

(cl:ensure-generic-function 'pos_x-val :lambda-list '(m))
(cl:defmethod pos_x-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:pos_x-val is deprecated.  Use unity_gopher-msg:pos_x instead.")
  (pos_x m))

(cl:ensure-generic-function 'pos_y-val :lambda-list '(m))
(cl:defmethod pos_y-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:pos_y-val is deprecated.  Use unity_gopher-msg:pos_y instead.")
  (pos_y m))

(cl:ensure-generic-function 'pos_z-val :lambda-list '(m))
(cl:defmethod pos_z-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:pos_z-val is deprecated.  Use unity_gopher-msg:pos_z instead.")
  (pos_z m))

(cl:ensure-generic-function 'rot_x-val :lambda-list '(m))
(cl:defmethod rot_x-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:rot_x-val is deprecated.  Use unity_gopher-msg:rot_x instead.")
  (rot_x m))

(cl:ensure-generic-function 'rot_y-val :lambda-list '(m))
(cl:defmethod rot_y-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:rot_y-val is deprecated.  Use unity_gopher-msg:rot_y instead.")
  (rot_y m))

(cl:ensure-generic-function 'rot_z-val :lambda-list '(m))
(cl:defmethod rot_z-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:rot_z-val is deprecated.  Use unity_gopher-msg:rot_z instead.")
  (rot_z m))

(cl:ensure-generic-function 'rot_w-val :lambda-list '(m))
(cl:defmethod rot_w-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_gopher-msg:rot_w-val is deprecated.  Use unity_gopher-msg:rot_w instead.")
  (rot_w m))
